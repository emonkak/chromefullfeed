window.top === window && (function(){
  ...
  var connection = {
    postMessage: function(obj) {
      safari.self.tab.dispatchMessage("content", JSON.stringify(obj));
    }
  };
  var Callbacks = {};
  var AP = {};
  ...
  script.src = safari.extension.baseURI+'ldr_page_script.js';
  ...
  var regset = function(info){
    ...
    JSON.stringify({
      ...
      "ICON"    : safari.extension.baseURI+'orange.gif'
    })+";})()";
  }
